...
QT_MOC_LITERAL(5, 67, 21), // "signal_signUpResponse"
QT_MOC_LITERAL(6, 89, 21), // "signal_signInResponse"
QT_MOC_LITERAL(7, 111, 28), // "signal_outputMessageResponse"
QT_MOC_LITERAL(8, 140, 18), // "slot_parseResponse"
QT_MOC_LITERAL(9, 159, 8) // "response"

    },
    "IClientProcessor\0signal_stopClient\0\0"
    "signal_sendRequest\0std::string\0"
    "signal_signUpResponse\0signal_signInResponse\0"
    "signal_outputMessageResponse\0"
    "slot_parseResponse\0response"
};
...
void IClientProcessor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->signal_signUpResponse((*reinterpret_cast< const std::string(*)>(_a[1]))); break;
        case 3: _t->signal_signInResponse((*reinterpret_cast< const std::string(*)>(_a[1]))); break;
        case 4: _t->signal_outputMessageResponse((*reinterpret_cast< const std::string(*)>(_a[1]))); break;
        case 5: _t->slot_parseResponse((*reinterpret_cast< const std::string(*)>(_a[1]))); break;
        default: ;
        }
