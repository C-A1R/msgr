...
QT_MOC_LITERAL(9, 160, 23), // "signal_getUsersResponse"
QT_MOC_LITERAL(10, 184, 21), // "std::vector<UserInfo>"
QT_MOC_LITERAL(11, 206, 26), // "signal_inputMessageRequest"
QT_MOC_LITERAL(12, 233, 18), // "slot_parseRecieved"
QT_MOC_LITERAL(13, 252, 3) // "msg"
    ...
    "signal_getUsersResponse\0std::vector<UserInfo>\0"
...
void IClientProcessor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 6: _t->signal_getUsersResponse((*reinterpret_cast< const std::vector<UserInfo>(*)>(_a[1]))); break;
        case 7: _t->signal_inputMessageRequest((*reinterpret_cast< const std::string(*)>(_a[1])),(*reinterpret_cast< const std::string(*)>(_a[2]))); break;
        case 8: _t->slot_parseRecieved((*reinterpret_cast< const std::string(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (IClientProcessor::*)(const std::vector<UserInfo> );
...
// SIGNAL 6
void IClientProcessor::signal_getUsersResponse(const std::vector<UserInfo> _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
