...
#include "../../main_window/messenger_widget/ChatWidget.h"
...
QT_MOC_LITERAL(1, 11, 17), // "signalSendMessage"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 11), // "std::string"
QT_MOC_LITERAL(4, 42, 16) // "slot_sendMessage"

    },
    "ChatWidget\0signalSendMessage\0\0std::string\0"
    "slot_sendMessage"
};
...
void ChatWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ChatWidget::*)(int , const std::string & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ChatWidget::signalSendMessage)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ChatWidget::signalSendMessage(int _t1, const std::string & _t2)
{
